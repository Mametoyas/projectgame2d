...
var waves = [
	["snake","snake","snake","snake","snake","Gnoll","money","Gnoll","Gnoll","Gnoll","Gnoll","Gnoll"],
	["runner","runner","runner","runner","runner","runner","Gnome","Gnome","Gnome","Gnome"],
	["runner","snake","regenerator","regenerator","regenerator"]
]
